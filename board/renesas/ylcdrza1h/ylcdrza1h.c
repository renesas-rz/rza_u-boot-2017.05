...
U_BOOT_DEVICE(ylcdrza1h_serial) = {
	.name = "serial_sh",
...
int board_early_init_f(void)
{
	...
	pfc_set_pin_function(11, 12, ALT4, 0, 1);		/* MMC DAT4 (bi dir)*/
	pfc_set_pin_function(11, 13, ALT4, 0, 1);		/* MMC DAT5 (bi dir) */
	pfc_set_pin_function(11, 14, ALT4, 0, 1);		/* MMC DAT6 (bi dir) */
	pfc_set_pin_function(11, 15, ALT4, 0, 1);		/* MMC DAT7 (bi dir) */
...
u8 button_check_state(u8 sw)
{
	/* returns: 1 = button up
		    0 = button pressed
	*/
	return gpio_read(7, 8);	/* Button S2 (USER) */
	return 1;
}
