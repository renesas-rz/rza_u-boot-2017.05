...
#define CONFIG_ARCH_RMOBILE_BOARD_STRING	"GRPEACH"
...
/* If you are using a SPI Flash device that does not have 4-byte address
   commands (Flash size <= 16MB), then define ADDRESS_BYTE_SIZE to 3 */
#define ADDRESS_BYTE_SIZE 3
...
#define CONFIG_R8A66597_BASE_ADDR	R8A66597_BASE0
